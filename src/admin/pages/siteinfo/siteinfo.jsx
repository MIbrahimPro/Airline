        ...
        <>
            ...
            <div className="siteinfo-page">
                ...
                <div className="buttons">
                    ...
                    <button onClick={handleNavigateAbout}>EDIT About Us</button>
                    <button onClick={handleNavigatePrivacy}>
                        EDIT Privacy Policy
                    </button>
                    <button onClick={handleNavigateTerms}>
